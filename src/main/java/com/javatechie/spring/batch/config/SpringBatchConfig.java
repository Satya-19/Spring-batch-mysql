...
import com.javatechie.spring.batch.listener.MyJobExecutionListener;
...
public class SpringBatchConfig {
    ...
    @Bean
    public ColumnRangePartitioner partitioner() { return new ColumnRangePartitioner(); }
    ...
    @Bean
    public Job runJob(MyJobExecutionListener listener) {
